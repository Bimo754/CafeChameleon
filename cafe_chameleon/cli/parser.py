...
def parse_arguments(args=None):
    ...
    s_opts.add_argument("--air", nargs="?", const=-1, type=int, default=None, metavar="SECS", help="Enable 802.11 monitor capture (0 for indefinite)")
    ...
    a_opts.add_argument("--air", nargs="?", const=-1, type=int, default=None, metavar="SECS", help="Enable 802.11 monitor capture (0 for indefinite until Ctrl+C)")
    a_opts.add_argument("--air-only", nargs="?", const=-1, type=int, default=None, dest="air_only", metavar="SECS", help="Enable 802.11 monitor capture only (0 for active-triggered 30s loop)")
